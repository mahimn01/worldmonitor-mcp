...
describe('Service Registry', () => {
  it('should have all 33 services registered', () => {
    // 32 proto (21 proxy + 11 direct, incl. trading) + 1 legacy
    expect(allServices.length).toBe(33);
    expect(protoServices.length).toBe(32);
